...
function ensureSharedFavicons() {
  ...
  const icons = [
    { rel: "icon", type: "image/svg+xml", href: "/images/favicon/favicon.svg?v=6", sizes: "any" },
    { rel: "icon", type: "image/png", href: "/images/favicon/favicon-64x64.png?v=6", sizes: "64x64" },
    { rel: "icon", type: "image/png", href: "/images/favicon/favicon-128x128.png?v=6", sizes: "128x128" },
    { rel: "icon", type: "image/png", href: "/images/favicon/favicon-256x256.png?v=6", sizes: "256x256" },
    { rel: "apple-touch-icon", href: "/images/favicon/favicon-256x256.png?v=6", sizes: "256x256" },
